...
static const Joints HOME = { 0, 45, 0, 0, 0, 0 };  // default rest pose (deg, math frame)
...
void servoBegin() {
  ...
  writePositional(CH_J5_GRIP,     cur.j5, J5_DIR, J5_OFFSET_DEG);
  writePositional(CH_J6_AUX,      cur.j6, J6_DIR, J6_OFFSET_DEG);
...
void servoSetTarget(const Joints& t) {
  ...
  tgt.j5 = constrain(t.j5, J5_MIN, J5_MAX);
  tgt.j6 = constrain(t.j6, J6_MIN, J6_MAX);
}
...
void servoJog(int joint, float d) {
  ...
  switch (joint) { case 1: t.j1+=d; break; case 2: t.j2+=d; break;
                   ...
                   case 5: t.j5+=d; break; case 6: t.j6+=d; break; }
  servoSetTarget(t);
}

void servoSetHome(const Joints& ref) { cur = ref; tgt = ref; }
void servoGoHome() { servoSetTarget(HOME); }   
...
bool servoBusy() {
  ...
  return fabsf(cur.j1-tgt.j1)>tol || fabsf(cur.j2-tgt.j2)>tol ||
         ...
         fabsf(cur.j5-tgt.j5)>tol || fabsf(cur.j6-tgt.j6)>tol;
}
...
void servoUpdate() {
  ...
  writePositional(CH_J4_WRIST, cur.j4, J4_DIR, J4_OFFSET_DEG);
  stepTo(cur.j5, tgt.j5, MOVE_STEP_DEG);
  writePositional(CH_J5_GRIP, cur.j5, J5_DIR, J5_OFFSET_DEG);
  stepTo(cur.j6, tgt.j6, MOVE_STEP_DEG);
  writePositional(CH_J6_AUX, cur.j6, J6_DIR, J6_OFFSET_DEG);
